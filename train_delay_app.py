...
# @st.cache_data  # Cache to avoid reloading data on every interaction
...
#     # One-hot encode categorical variables (updated for newer scikit-learn versions)
#     # Changed 'sparse' to 'sparse_output'
...
#     return df, encoder, model, feature_names
...
# # Load data and model
# df, encoder, model, feature_names = load_and_train_model()
...
#     # Create a column for train route
#     df['Route'] = df['From'] + " to " + df['To']

#     # Get top 10 trains by delay
